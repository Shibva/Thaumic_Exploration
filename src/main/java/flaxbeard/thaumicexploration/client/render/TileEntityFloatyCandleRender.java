...
public class TileEntityFloatyCandleRender extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation candleTexture =
            new ResourceLocation("thaumicexploration:textures/models/floatyCandle.png");
    private static final ResourceLocation wickTexture =
            new ResourceLocation("thaumicexploration:textures/models/floatyCandleStub.png");
    ...
    public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float f) {
        ...
        Color color = new Color(ConfigBlocks.blockCandle.getRenderColor(
