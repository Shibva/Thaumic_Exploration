...
public final class ModResearch {
    ...
    public static ItemStack getOriginalItem(String name, String category) {
        return ((ResearchCategoryList) ResearchCategories.researchCategories.get(category))
                .research.get(name).icon_item;
    }

    public static ResourceLocation getOriginalGraphic(String name, String category) {
        return ((ResearchCategoryList) ResearchCategories.researchCategories.get(category))
                .research.get(name).icon_resource;
    }
    ...
    public static void initResearch() {
        ...
        research = new TXResearchItem(
                        ...
                        3,
                        1,
                        new ItemStack(ThaumicExploration.discountRing, 1, 2))
        ...
        research.setPages(
                new ResearchPage("1"), new ResearchPage((IArcaneRecipe[]) scer.toArray(new IArcaneRecipe[0])));

        // Curing
        research = new FauxResearchItem(
                        "TXTALLOW", "TX", "TALLOW", "ALCHEMY", -6, -11, getOriginalItem("TALLOW", "ALCHEMY"))
                .registerResearchItem();
        research = new FauxResearchItem(
                        "TXINFUSION", "TX", "INFUSION", "ARTIFICE", 2, -7, getOriginalItem("INFUSION", "ARTIFICE"))
                .registerResearchItem();
        research = new TXResearchItem(
                        "FLESHCURE",
                        "TX",
        ...
        if (ConfigTX.allowBoots) {
            research = new FauxResearchItem(
                            ...
                            1,
                            -4,
                            getOriginalItem("BOOTSTRAVELLER", "ARTIFICE"))
        ...
        if (ConfigTX.allowSojourner || ConfigTX.allowMechanist) {
            research = new FauxResearchItem(
                            ...
                            -7,
                            -7,
                            getOriginalItem("CAP_thaumium", "THAUMATURGY"))
                    .registerResearchItem();
        }
        if (ConfigTX.allowSojourner) {
            research = new TXResearchItem(
                    ...
                    .registerResearchItem();
            research.setPages(
                    new ResearchPage("1"), arcaneRecipePage("UNCHARGEDSOJOURNER"), infusionPage("CAP_SOJOURNER"));
        }
        ...
        if (ConfigTX.allowMechanist) {
            research = new TXResearchItem(
                    ...
                    .registerResearchItem();
            research.setPages(
                    new ResearchPage("1"), arcaneRecipePage("UNCHARGEDMECHANIST"), infusionPage("CAP_MECHANIST"));
        }

        ResourceLocation taint = new ResourceLocation("thaumicexploration:textures/tabs/taintResearch2.png");
        research = new TXResearchItem("TAINTBASICS", "TX", new AspectList(), -9, 0, 0, taint)
                .setAutoUnlock()
                .setStub()
                .setRound()
                .registerResearchItem();
        ...
        if (ConfigTX.allowEnchants) {
            research = new FauxResearchItem(
                            ...
                            -5,
                            -6,
                            getOriginalGraphic("INFUSIONENCHANTMENT", "ARTIFICE"))
                    .registerResearchItem();
        ...
        research = new FauxResearchItem(
                        ...
                        -3,
                        -2,
                        getOriginalItem("ROD_greatwood", "THAUMATURGY"))
                .registerResearchItem();
        research = new TXResearchItem(
                        "ROD_AMBER",
                        "TX",
                ...
                .setParents(
                        "TXROD_greatwood", "ROD_obsidian", "ROD_reed", "ROD_blaze", "ROD_ice", "ROD_quartz", "ROD_bone")
                .setConcealed()
                .registerResearchItem();
        ...
        research = new FauxResearchItem(
                        ...
                        -3,
                        3,
                        getOriginalItem("ROD_greatwood_staff", "THAUMATURGY"))
                .registerResearchItem();
        research = new TXResearchItem(
        ...
        research = new FauxResearchItem(
                        "TXJARVOID", "TX", "JARVOID", "ALCHEMY", 7, -10, getOriginalItem("JARVOID", "ALCHEMY"))
                .registerResearchItem();
        research = new TXResearchItem(
                        "TRASHJAR",
                        "TX",
    ...
    private static void registerResearchPages() {
        ...
        ResearchCategories.registerCategory(
                "TX", new ResourceLocation("thaumicexploration:textures/tabs/txTab.png"), background2);
    }
